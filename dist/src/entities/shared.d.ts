...
export interface ISharedDataConnects<T extends IEntity> {
    ...
    update: (query: IQueryOrPartial<T>, update: IEntityPartial<T>, config?: IModelConfigurationDetails) => Promise<T[]>;
    ...
    findOrCreate: (criteria: IQueryOrPartial<T>, initialsValues: IEntityPartial<T>, config?: IModelConfigurationDetails) => Promise<T>;
